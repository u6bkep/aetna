...
impl El {
    ...
    /// [`name`][method@Self::name] as well, which labels a graphic
    /// control with no root requirement at all.
    ///
    ...
    pub fn tooltip(mut self, text: impl Into<String>) -> Self {
        ...
        self.semantics.get_or_insert_with(Default::default).tooltip = Some(text);
        self
    }
